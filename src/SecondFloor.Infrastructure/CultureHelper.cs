...
namespace SecondFloor.Infrastructure
{
    public static class CultureHelper
    {
        ...
        //culturas a implementadas
        private static readonly List<string> _cultures = new List<string>(){"en-US", "pt-BR"};

        /// <summary>
        /// Retorna trye, caso a linguagem seja da esqueda para a direita ou false caso contrario
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Retorna uma cultura valida no parametro nome, caso nao seja uma cultura valida retorna o padrao en-US
        /// </summary>
        ...
        public static string GetImplementedCulture(string name)
        {
            ...
            if (_cultures.Where(c => c.Equals(StringComparison.InvariantCultureIgnoreCase)).Count() > 0)
                return name;
        ...
        /// <summary>
        /// Retorna o nome da primeira cultura como padrão
        /// </summary>
        /// <returns></returns>
