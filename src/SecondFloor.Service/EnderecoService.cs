...
namespace SecondFloor.Service
{
    public class EnderecoService : IEnderecoService
    {
        ...
        public EncontrarEnderecoResponse EncontrarEndereco(EncontrarEnderecoRequest request)
        {
        ...
        public CadastroEnderecoResponse CadastroEndereco(CadastroEnderecoRequest request)
        {
            var response = new CadastroEnderecoResponse();
        ...
        public AlterarEnderecoResponse AlterarEndereco(AlterarEnderecoRequest request)
        {
            ...
            try
            {
                ...
                if (endereco.GetBrokenBusinessRules().Count > 0)
                {
                    response.Message = novoEndereco.GetErrorMessages().ToString();
                    response.MessageType = "alert-warning";
                    response.Success = false;
                    return response;
                }
